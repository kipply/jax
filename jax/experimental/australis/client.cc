...
absl::StatusOr<Client> Client::Get(absl::string_view name) {
...
absl::string_view Client::platform_name() const {
...
absl::StatusOr<absl::InlinedVector<std::unique_ptr<xla::Literal>, 1>>
DeviceArray::ToLiterals() const {
  absl::InlinedVector<std::unique_ptr<xla::Literal>, 1> out;
...
void DeviceArray::ToLiteralAsync(
    size_t idx,
