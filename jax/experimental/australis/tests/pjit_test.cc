...
TEST(Pjit, SimplePjit) {
  ...
  ASSERT_OK_AND_ASSIGN(auto literals, result.ToLiteralShards());
...
TEST(Pjit, MultiReturn) {
  ...
  ASSERT_OK_AND_ASSIGN(auto y_plus_one, results[1].ToLiteralShards());
...
TEST(Pjit, DonateArgPjit) {
  ...
  ASSERT_OK_AND_ASSIGN(auto lit0, elements[0].ToLiteralShards());
  ...
  ASSERT_OK_AND_ASSIGN(auto lit1, elements[0].ToLiteralShards());
